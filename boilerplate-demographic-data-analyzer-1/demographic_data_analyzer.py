...
def calculate_demographic_data(print_data=True):
    ...
    he_count = len(higher_education[higher_education['salary'] == ">50K"])
    he_total = len(higher_education)

    le_count = len(lower_education[lower_education['salary'] == ">50K"])
    le_total = len(lower_education)

    higher_education_rich = round(he_count/he_total * 100, 1)
    lower_education_rich = round(le_count/le_total * 100, 1)
    ...
    occupation_counts = people_india['occupation'].value_counts()
